!(function (e, t, i, n) {
    ...
    i.extend(r, {
            ...
            return e && (i.isPlainObject(t) || (t = {}), !1 !== r.close(!0))
                ? (i.isArray(e) || (e = h(e) ? i(e).get() : [e]),
                    i.each(e, function (a, s) {
                        ...
                        "object" === i.type(s) &&
                            (s.nodeType && (s = i(s)),
                                h(s) ? ((m = { href: s.data("fancybox-href") || s.attr("href"), title: s.data("fancybox-title") || s.attr("title"), isDom: !0, element: s }), i.metadata && i.extend(!0, m, s.metadata())) : (m = s)),
                            (o = t.href || m.href || (p(s) ? s : null)),
                            (l = t.title !== n ? t.title : m.title || ""),
                            (c = t.content || m.content),
                            (d = c ? "html" : t.type || m.type),
                            !d && m.isDom && ((d = s.data("fancybox-type")), d || ((u = s.prop("class").match(/fancybox\.(\w+)/)), (d = u ? u[1] : null))),
                            p(o) &&
                            (d || (r.isImage(o) ? (d = "image") : r.isSWF(o) ? (d = "swf") : "#" === o.charAt(0) ? (d = "inline") : p(s) && ((d = "html"), (c = s))),
                                "ajax" === d && ((f = o.split(/\s+/, 2)), (o = f.shift()), (g = f.shift()))),
                            c || ("inline" === d ? (o ? (c = i(p(o) ? o.replace(/.*(?=#[^\s]+$)/, "") : o)) : m.isDom && (c = s)) : "html" === d ? (c = o) : d || o || !m.isDom || ((d = "inline"), (c = s))),
                            i.extend(m, { href: o, type: d, content: c, title: l, selector: g }),
                            (e[a] = m);
                    }),
            ...
            var t = function () {
                ...
                a = function () {
                    r.current &&
                        ...
                        ((r.player.isActive = !0), o.bind({ "onCancel.player beforeClose.player": n, "onUpdate.player": i, "beforeLoad.player": t }), i(), r.trigger("onPlayStart"));
                };
        ...
        _start: function (e) {
            ...
            if (
                ((r.isActive = !0),
                    ("image" === a || "swf" === a) && ((l.autoHeight = l.autoWidth = !1), (l.scrolling = "visible")),
                    "image" === a && (l.aspectRatio = !0),
                    "iframe" === a && d && (l.scrolling = "scroll"),
                    (l.wrap = i(l.tpl.wrap)
                        .addClass("fancybox-" + (d ? "mobile" : "desktop") + " fancybox-type-" + a + " fancybox-tmp " + l.wrapCSS)
        ...
        _afterLoad: function () {
            ...
            if ((r.hideLoading(), l && r.isActive !== !1)) {
                ...
                (h(t) && t.parent().is(e.inner)) || e.inner.append(t),
                    ...
                    e.inner.css("overflow", "yes" === a ? "scroll" : "no" === a ? "hidden" : a),
                    r._setDimension(),
                    r.reposition(),
                    (r.isOpen = !1),
                    (r.coming = null),
        ...
        _setDimension: function () {
            var e,
                ...
                O = g(M[0] + M[2]);
            if (
                (j.add(C).add(I).width("auto").height("auto").removeClass("fancybox-tmp"),
            ...
            if (
                ((S = g(s)),
                    ...
                    (v = y.h - O),
                    T.aspectRatio
                        ? (S > D && ((S = D), (W = g(S / d))), W > A && ((W = A), (S = g(W * d))), H > S && ((S = H), (W = g(S / d))), L > W && ((W = L), (S = g(W * d))))
                        : ((S = Math.max(H, Math.min(S, D))), T.autoHeight && "iframe" !== T.type && (I.width(S), (W = I.height())), (W = Math.max(L, Math.min(W, A)))),
                    T.fitToView)
            )
            ...
            B && "auto" === P && o > W && f > S + e + B && (S += B),
                ...
                (p = j.height()),
                (_ = (h > f || p > v) && S > H && W > L),
                (k = T.aspectRatio ? l > S && c > W && s > S && o > W : (l > S || c > W) && (s > S || o > W)),
                i.extend(T, { dim: { width: m(h), height: m(p) }, origWidth: s, origHeight: o, canShrink: _, canExpand: k, wPadding: e, hPadding: t, wrapSpace: p - C.outerHeight(!0), skinSpace: C.height() - W }),
        ...
        _getPosition: function (e) {
            ...
            return (
                t.autoCenter && t.fixed && !e && s <= i.h && a <= i.w ? (o.position = "fixed") : t.locked || ((o.top += i.y), (o.left += i.x)),
        ...
        _afterZoomIn: function () {
            ...
            e &&
                ((r.isOpen = r.isOpened = !0),
                    ...
                    e.arrows && r.group.length > 1 && ((e.loop || e.index > 0) && i(e.tpl.prev).appendTo(r.outer).bind("click.fb", r.prev), (e.loop || e.index < r.group.length - 1) && i(e.tpl.next).appendTo(r.outer).bind("click.fb", r.next)),
                    r.trigger("afterShow"),
        ...
        (r.transitions = {
            getOrigPosition: function () {
                ...
                return (
                    ...
                    h(i) ? ((n = i.offset()), i.is("img") && ((a = i.outerWidth()), (s = i.outerHeight()))) : ((n.top = c.y + (c.h - s) * e.topRatio), (n.left = c.x + (c.w - a) * e.leftRatio)),
                    ("fixed" === r.wrap.css("position") || e.locked) && ((n.top -= c.y), (n.left -= c.x)),
                    (n = { top: m(n.top - o * e.topRatio), left: m(n.left - l * e.leftRatio), width: m(a + l), height: m(s + o) })
                );
            },
            step: function (e, t) {
                var i,
            ...
            zoomIn: function () {
                ...
                delete s.position,
                    ...
                    r.wrap.css(t).animate(s, { duration: "none" === n ? 0 : e.openSpeed, easing: e.openEasing, step: a ? this.step : null, complete: r._afterZoomIn });
            },
            zoomOut: function () {
                var e = r.current,
                    t = e.closeEffect,
            ...
            changeIn: function () {
                var e,
                    ...
                    o = 200;
                (n.opacity = 0.1),
                    "elastic" === i && ((e = "down" === s || "up" === s ? "top" : "left"), "down" === s || "right" === s ? ((n[e] = m(g(n[e]) - o)), (a[e] = "+=" + o + "px")) : ((n[e] = m(g(n[e]) + o)), (a[e] = "-=" + o + "px"))),
                    "none" === i ? r._afterZoomIn() : r.wrap.css(n).animate(a, { duration: t.nextSpeed, easing: t.nextEasing, complete: r._afterZoomIn });
            },
            changeOut: function () {
                var e = r.previous,
                    t = e.prevEffect,
        ...
        (r.helpers.overlay = {
            ...
            update: function () {
                ...
                this.overlay.width(i).height("100%"),
                    l ? ((e = Math.max(t.documentElement.offsetWidth, t.body.offsetWidth)), o.width() > e && (i = o.width())) : o.width() > s.width() && (i = o.width()),
            ...
            onReady: function (e, t) {
                ...
                i(".fancybox-overlay").stop(!0, !0),
                    n || this.create(e),
                    e.locked && this.fixed && t.fixed && (n || (this.margin = o.height() > s.height() ? i("html").css("margin-right").replace("px", "") : !1), (t.locked = this.overlay.append(t.wrap)), (t.fixed = !1)),
        ...
        (i.fn.fancybox = function (e) {
            ...
            return (
                (e = e || {}),
                (t = e.index || 0),
                a && e.live !== !1 ? o.undelegate(a, "click.fb-start").delegate(a + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", s) : n.unbind("click.fb-start").bind("click.fb-start", s),
