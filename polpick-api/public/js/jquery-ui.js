...
(function (factory) {
	...
	$.widget = function (name, base, prototype) {
		...
		$.expr[":"][full_name.toLowerCase()] = function (elem) {
			return !!$.data(elem, full_name);
		};
	...
	$.widget.bridge = function (name, object) {
		var full_name = object.prototype.widgetFullName || name;
			...
			if (isMethodCall) {
				...
				this.each(function () {
					...
					if (instance) {
						...
						$.data(this, full_name, new object(options, this));
					}
				});
			}
