...
export default function WinTable({ winners, isLoading }: WinTableProps) {
  const [order, setOrder] = useState<"asc" | "desc">("desc");
  const [orderBy, setOrderBy] = useState<keyof TableData>("totalWinsCount");
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody className="table_section">
              {winners?.length
                ? stableSort(winners as any, getComparator(order, orderBy)).map(
                    (row, index) => {
